...
export const metadata: Metadata = {
  title: "AISetup - AI Platform Made Simple",  description: "Deploy, manage, and scale AI models effortlessly. Enterprise-grade AI infrastructure with Apple-inspired simplicity. Start your free trial today.",  keywords: "AI platform, machine learning, model deployment, artificial intelligence, AI infrastructure, deep learning",  metadataBase: new URL("https://aisetup.example.com"),
  alternates: {
    canonical: "https://aisetup.example.com"
  },
  openGraph: {
    title: "AISetup - Simplified AI Infrastructure",    description: "Transform your AI operations with our intuitive platform. Deploy models in minutes, scale effortlessly.",    url: "https://aisetup.example.com",    siteName: "AISetup",    type: "website",    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3ARKsGhAqpoK0xtsNt6STlNoVV9/a-sleek-modern-ai-setup-dashboard-with-c-1772550258526-1ef5ca60.png",        alt: "AISetup Platform Dashboard"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "AISetup - AI Platform Made Simple",    description: "Deploy, manage, and scale AI models with enterprise-grade infrastructure and Apple-inspired simplicity.",    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3ARKsGhAqpoK0xtsNt6STlNoVV9/a-sleek-modern-ai-setup-dashboard-with-c-1772550258526-1ef5ca60.png"]
  },
  robots: {
    index: true,
    follow: true
